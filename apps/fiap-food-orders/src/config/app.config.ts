import { CommonModuleOptions, CommonOptionsFactory } from '@fiap-food/setup';
...
export class AppConfig implements CommonOptionsFactory {
  ...
  createOptions(): CommonModuleOptions {
    ...
    return {
      ...
      openApiServers: [
        // ::KeepStyle::
        // { url: 'https://app.fiapfoodev', description: 'production' },
        // { url: 'https://stg-app.fiapfoodev', description: 'staging' },
        // { url: 'https://dev-app.fiapfoodev', description: 'development' },
