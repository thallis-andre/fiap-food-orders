...
import { FiapFoodPreparationService } from './fiap-food-preparation.service';

describe('MongooseFiapFoodPreparationService', () => {
  let app: INestApplication;
  let target: FiapFoodPreparationService;
  ...
  beforeEach(async () => {
    ...
    target = app.get(FiapFoodPreparationService);
  ...
  it('should instantiate correctly', async () => {
    expect(target).toBeInstanceOf(FiapFoodPreparationService);
  });
